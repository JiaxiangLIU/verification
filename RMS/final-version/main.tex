...
\author{
  ...
  Jiaxiang~Liu,
  Min~Zhou,
  Xiaoyu~Song, \emph{Senior Member}, \emph{IEEE},
  Ming~Gu,
  and Jiaguang~Sun
...
would be more complicated than this standard, ideal setting.
%% Assumption
(A1) will be modified because of the interrupt mask
mechanism, while (A4) is relaxed to obtain a more realistic analysis
model.
...
} \mathit{statePattern} \texttt{ |= } \mathit{prop} \texttt{ = } b \texttt{ if } cond$,
with $b$ a term of sort \verb|Bool|, stating that $\mathit{prop}$ evaluates to
$b$ in states which are instances of $\mathit{statePattern}$ provided the
condition $cond$ holds. These equations together define $\mathit{prop}$ to hold
in all states $s$ that make $s \texttt{ |= } \mathit{prop}$ evaluate to
...
\begin{figure}[!t]
\centering
\includegraphics[width=8.8cm]{rms-pseudocode.pdf}
...
$\mathit{schedule()}$. This behavior is modeled by the following instantaneous
rewrite rule:
\begin{verbatim}
...
%% As to the 
Schedulability property holds in Scenarios~(i--iii), but
...
pictured in Fig.~\ref{f:counterexample}, where
$\tau_3$ misses its deadline at time $15ms$.
...
The last one is that, considering overhead and details of hardware does
...
$\sigma(l)$ of each left-hand side $l$ of an instantaneous rewrite rule.
\end{enumerate}
\end{lemma}
...
\\
= & \mteTask{ID}{L}~\verb|monus|~r\;. \hfill\IEEEQEDhere
\end{IEEEeqnarray*}
\end{IEEEproof}
\begin{lemma}
\label{l:auxis}
...
=\deltaTask{\mathit{ID}}{L}{r+r'}$ holds by the associativity of $+$,
while
...
\bibliography{Bibliography/IEEEabrv,Bibliography/main}\ 
...
\vspace{-5mm}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{1.jpg}}]%
{Jiaxiang Liu} received his B.S.\ degree in software engineering from
Tsinghua University, China in 2010. He is currently working toward the
Ph.D.\ degree in computer science at Tsinghua University, China. 
...
\vspace{-5mm}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{M_Zhou1.jpg}}]%
{Min Zhou} received his B.S.\ degree in mathematics and applied
mathematics, and the Ph.D.\ degree in computer science from Tsinghua
University, China in 2007 and 2014, respectively. 

He is currently a lecturer at the School of Software, Tsinghua
University, China. His research interests include model checking,
program analysis and testing.
\end{IEEEbiography}

\vspace{-5mm}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{X_Song1.jpg}}]%
...
\vspace{-5mm}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{M_Gu1.jpg}}]%
...
University, China. 
%% She is also vice-director of Key Laboratory for
%% Information System Security, Ministry of Education, China. 
Her research interests include software formal methods, software
trustworthiness and middleware technology.
\end{IEEEbiography}

\vspace{-5mm}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{J_Sun1.jpg}}]%
...
dean of the School of Information Science and Technology in Tsinghua
University, China. He is also a member of the Chinese Academy of
Engineering, and director of Tsinghua National Laboratory for
Information Science and Technology, China. 
His research interests
include computer graphics, computer-aided design, formal verification
of software, software engineering and system architecture.
\end{IEEEbiography}

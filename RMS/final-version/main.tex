...
Figure~\ref{f:schedule}) in the model. Then $timer$ is of sort
...
Figure~\ref{f:schedule} but is reasonable. The upper bound is the
...
$updateStatus()$ in Figure~\ref{f:schedule}, which is treated as an
...
$updateStatus()$ in Figure~\ref{f:schedule}.
...
Figure~\ref{f:schedule}. It updates the status of $taskList$ and
...
Figure~\ref{f:schedule}, searching the task with highest priority

...
\jx{
  ...
  Using a model-based checking approach enhance the ability to check
  other scheduling algorithms.

  About non-determinism: task finishes right at the time interrupt
  comes, theoretical results cannot solve

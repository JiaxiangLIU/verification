...
our model, if the running task is complete ``right'' at the time when
an interrupt request is performed, two different behaviors are
...
the system answers the interrupt request immediately.

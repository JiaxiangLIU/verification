...
several different scenarios, containing both realistic and
experimental ones.

The main objective is to verify the schedubility of a given set of
...
\subsection{Properties Formalism}

...
occurs, if the system is interruptable, i.e. the interrupt mask bit is
...
\end{tikzpicture}
\caption{A counterexample of schedulablity in Scenario~(iv). The first
...
taking into acount the overhead of scheduling and switching, and by

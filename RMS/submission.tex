...
rules. In particular, modeling of instaneous behaviors would be
...
We also need a sort \verb|Interval|
to denote computation requirements of tasks, 
and a sort \jx{} \verb|Counter| to

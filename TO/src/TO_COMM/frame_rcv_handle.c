 ...
 * @brief ï¿½ï¿½ï¿½ï¿½frameï¿½ï¿½ï¿½Õºï¿½Ä²ï¿½ï¿½ï¿½
 * @author danny
 * @date 2015.02.03
 **/
   ...
   printf("frame command is %d %d %d\n",command[0],command[1],command[2]);
	...
	case SOURCE_CORE_3:
		...
		case EVENT_ROUTE_VERSION_RESULT:
			...
			break;
		case EVENT_ROUTE_DATA_SEND_ACK: /* ½»Â·Êý¾Ý°æ±¾²»Ò»ÖÂ´¦Àí£º½»Â·ÌáÈ¡Íê³É²¢·¢ËÍ£ºÆÂ¶ÈÓ¦´ð */
			route_data_confirm[0] = command[2];
			break;
		case EVENT_ROUTE_DATA_CURVE_ACK: /* ½»Â·Êý¾Ý°æ±¾²»Ò»ÖÂ´¦Àí£º·¢ËÍ£ºÇúÏßÓ¦´ð  */
			route_data_confirm[1] = command[2];
			break;
		case EVENT_ROUTE_DATA_LIMIT_ACK: /* ½»Â·Êý¾Ý°æ±¾²»Ò»ÖÂ´¦Àí£º·¢ËÍ£ºÏÞËÙÓ¦´ð  */
			route_data_confirm[2] = command[2];
			break;
		case EVENT_ROUTE_DATA_TELESEME_ACK: /* ½»Â·Êý¾Ý°æ±¾²»Ò»ÖÂ´¦Àí£º·¢ËÍ£ºÐÅºÅ»úÓ¦´ð  */
			route_data_confirm[3] = command[2];
			break;
		case EVENT_ROUTE_DATA_TUNNEL_ACK: /* ½»Â·Êý¾Ý°æ±¾²»Ò»ÖÂ´¦Àí£º·¢ËÍ£ºËíµÀÓ¦´ð  */
			route_data_confirm[4] = command[2];
			break;
		case EVENT_ROUTE_DATA_STATION_ACK: /* ½»Â·Êý¾Ý°æ±¾²»Ò»ÖÂ´¦Àí£º·¢ËÍ£º³µÕ¾Ó¦´ð  */

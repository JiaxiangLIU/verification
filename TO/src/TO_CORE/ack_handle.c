...
//	{0, {EVENT_CORE_REGISTER, MY_SEND_EVENT_SOURCE}, {SOURCE_VOTE_0, TABLE_NONE}},
	{0, {EVENT_ROUTE_VERSION_RESULT, MY_SEND_EVENT_SOURCE}, {SOURCE_COM_0, TABLE_NONE}},
	{1, {EVENT_TRIP_OPT_COMPLETE, MY_SEND_EVENT_SOURCE}, {SOURCE_VOTE_0, TABLE_NONE}},
	{TABLE_NONE, {TABLE_NONE}, {TABLE_NONE}}
};

static send_type slave_ack_table[] = {
	{EVENT_BROADCAST_COM_ADDR, SOURCE_VOTE_0},/* TODO: add the event you need*/
	{EVENT_MASTER_VOTE_EXCHANGE, SOURCE_VOTE_0},
	{EVENT_SYS_TRIP_STATUS_SEND, SOURCE_VOTE_0},
	{EVENT_VOTE_SENT_MARSHALLING, SOURCE_VOTE_0},
	{EVENT_SEND_TRIP_TO_CORE, SOURCE_VOTE_0},
	{EVENT_SEND_MAR_TO_CORE, SOURCE_VOTE_0},

	{EVENT_DUTY_ASSISTING_CHANGE, SOURCE_COM_0},
	{EVENT_ROUTE_VERSION_SEND, SOURCE_COM_0},

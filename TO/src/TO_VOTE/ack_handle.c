...
static ack_type ack_table[] = { /* FIXME: commu board has two addresses */
	{0, {EVENT_MASTER_VOTE_EXCHANGE, MY_SEND_EVENT_SOURCE}, {SOURCE_COM_0,SOURCE_CORE_0,SOURCE_CONTROL_0, TABLE_NONE}},
	{1, {EVENT_LOCK_SCREEN, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},
	{2, {EVENT_VOTE_TRIP_INIT_START, MY_SEND_EVENT_SOURCE}, {SOURCE_COM_0, TABLE_NONE}},
	{3, {EVENT_SYS_TRIP_STATUS_SEND, MY_SEND_EVENT_SOURCE}, {SOURCE_COM_0,SOURCE_CORE_0,SOURCE_CONTROL_0, TABLE_NONE}},

	{4, {EVENT_TWO_GEAR_CONFIRM, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},
	{5, {EVENT_MANNAL_COMPLETE, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},
	{6, {EVENT_AUTO_COMPLETE, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},
	{7, {EVENT_AUTO_TIME_ALARM, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},

	{8, {EVENT_MANNUL_TIME_ALARM, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},
	{9, {EVENT_BRAKE_GEAR0, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},
	{10, {EVENT_GEAR8_AUTO_CONFIRM, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},

	{11, {EVENT_VOTE_UPDATE_MARSHALLING, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},
	{12, {EVENT_VOTE_SENT_MARSHALLING, MY_SEND_EVENT_SOURCE}, {SOURCE_CORE_0, TABLE_NONE}},
	{13, {EVENT_DISP_AUTO, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},
	{14, {EVENT_DISP_MANNAL, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},

	{15, {EVENT_TRIP_UPDATE, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},
	{16, {EVENT_SEND_TRIP_TO_CORE, MY_SEND_EVENT_SOURCE}, {SOURCE_CORE_0, TABLE_NONE}},
	{17, {EVENT_MAR_UPDATE, MY_SEND_EVENT_SOURCE}, {SOURCE_CONTROL_0, TABLE_NONE}},
	{18, {EVENT_SEND_MAR_TO_CORE, MY_SEND_EVENT_SOURCE}, {SOURCE_CORE_0, TABLE_NONE}},

	{19,{EVENT_BROADCAST_COM_ADDR,MY_SEND_EVENT_SOURCE},{SOURCE_COM_0,SOURCE_CORE_0, TABLE_NONE}},
	{ TABLE_NONE, { TABLE_NONE }, { TABLE_NONE } }
};

static send_type slave_ack_table[] = {
	{EVENT_LKJ_VERSION_DIFFERENCE,SOURCE_COM_0},
	{EVENT_TRIP_STATUS_NOTICE,SOURCE_COM_0},
   {EVENT_DUTY_ASSISTING_CHANGE,SOURCE_COM_0},
	{EVENT_MARSHALLING_RE_CHANGE,SOURCE_COM_0},
	{EVENT_TRIP_CHANGE,SOURCE_COM_0},
	{EVENT_MARSHALLING_CHANGE,SOURCE_COM_0},
	{EVENT_CLOCK_SYNC,SOURCE_COM_0},

	{EVENT_TRIP_OPT_COMPLETE,SOURCE_CORE_0},


	{EVENT_TRIP_INIT_START,SOURCE_CONTROL_0},
	{EVENT_CTRL_BOX_MASTER_SET,SOURCE_CONTROL_0},
	{EVENT_MANNAL_TO_AUTO,SOURCE_CONTROL_0},
	{EVENT_AUTO_TO_MANNAL,SOURCE_CONTROL_0},
	{EVENT_TWO_GEAR_TO_MANNUL,SOURCE_CONTROL_0},
	{EVENT_GEAR8_AUTO_CONFIRM_ACK,SOURCE_CONTROL_0},
	{EVENT_TRIP_OVER,SOURCE_CONTROL_0},
...
{
	set_abnormal_code(error_code, CON_0_DES);

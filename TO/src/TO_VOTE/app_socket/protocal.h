...
#define COM_0_SOURCE  0x00
#define COM_1_SOURCE  0x01
#define CORE_0_SOURCE 0x02
#define CORE_1_SOURCE 0x03
#define CORE_2_SOURCE 0x04
#define CORE_3_SOURCE 0x05
#define VOTE_0_SOURCE 0x08
#define CONTROL_0_SOURCE  0x06
#define CONTROL_1_SOURCE  0x07
#define INPUT_0_SOURCE    0x09
#define OUTPUT_0_SOURCE   0x10


#define CON_0_DES  0x02
#define CON_1_DES  0x04             // control box 2
...
#define MAX_DATA_FRAME_SIZE 4110   /*最大传输数据帧大小*/ 
 ...
 * @param stype socket类型 0x80 0x40 0x20(命令帧) 0x10 0x08(实时信息通道) 0x04
